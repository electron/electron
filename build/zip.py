...
PATHS_TO_SKIP = [
  ...
  'angledata',
  # Skip because ANGLE is statically linked on Linux; these are dummy stubs
  ...
  # These exact names only occur on Linux (Windows uses .dll, and the macOS
  # dylibs live inside the framework bundle).
  './libEGL.so',
  './libGLESv2.so',
