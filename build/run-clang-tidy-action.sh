...
# generated by script/gen-clang-tidy-ninja.py. This is CI plumbing: only the
# generated clang_tidy.ninja should run it. Invoked as
#
...
"$clang_tidy" -p "$output.compdb" --quiet --warnings-as-errors='*' "$source"
