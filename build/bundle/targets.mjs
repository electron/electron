...
//   calls. Bundles without it must be fully self-contained; `process` comes
//   from the browser polyfill in node_modules and `events` is a native
//   EventEmitter (lib/common/node-events.ts).
