...
// TODO(reito): Remove this function and use default 1.0f when breaking change
// is announced for a sufficient period.
...
OffScreenRenderWidgetHostView::OffScreenRenderWidgetHostView(
  ...
  // TODO(reito): Remove this when breaking change is announced for a sufficient
  // period.
  if (offscreen_device_scale_factor_ == 0.0f) {
