...
void ElectronDesktopWindowTreeHostLinux::SetWindowIcons(const gfx::ImageSkia& window_icon,
...
void ElectronDesktopWindowTreeHostLinux::Show(ui::mojom::WindowShowState show_state,
