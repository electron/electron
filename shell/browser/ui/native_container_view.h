...
#ifndef ELECTRON_SHELL_BROWSER_UI_NATIVE_CONTAINER_VIEW_H_
#define ELECTRON_SHELL_BROWSER_UI_NATIVE_CONTAINER_VIEW_H_
...
#endif  // ELECTRON_SHELL_BROWSER_UI_NATIVE_CONTAINER_VIEW_H_
