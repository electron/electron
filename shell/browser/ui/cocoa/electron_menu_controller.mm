...
Role kRolesMap[] = {
    ...
    {@selector(toggleAutomaticQuoteSubstitution:), "smartquotes"},
    {@selector(toggleAutomaticDashSubstitution:), "smartdashes"},
    {@selector(toggleAutomaticTextReplacement:), "textreplacement"},
