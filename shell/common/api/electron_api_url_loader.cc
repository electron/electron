...
void SimpleURLLoaderWrapper::OnCertificateRequested(
  ...
  // This line does not route client certificate requests to the app
  // (select-client-certificate for net requests landed in 44); keep the
  // observer's previous no-op behaviour.
}
