{
  'variables': {
    ...
    'extension_sources': [
      ...
      'atom/browser/extensions/extension_renderer_state.cc',
      'atom/browser/extensions/extension_renderer_state.h',
      ...
      'atom/renderer/extensions/atom_extensions_render_view_observer.cc',
      'atom/renderer/extensions/atom_extensions_render_view_observer.h',
    ...
    ['OS=="mac" or OS=="linux"', {
      'variables': {
        'extension_libraries': [
          ...
          '<(libchromiumcontent_dir)/libcast_common.a',
          '<(libchromiumcontent_dir)/libcast_net.a',
          ...
          '<(libchromiumcontent_dir)/libcommon_constants.a',
          '<(libchromiumcontent_dir)/libcommon_net.a',
          ...
          '<(libchromiumcontent_dir)/libweb_cache_common.a',
    ...
    ['OS=="win"', {
      'variables': {
        'extension_libraries': [
          ...
          '<(libchromiumcontent_dir)/cast_common.lib',
          '<(libchromiumcontent_dir)/cast_net.lib',
          '<(libchromiumcontent_dir)/chrome_api.lib',
          # Not built by libchromiumcontent on windows: '<(libchromiumcontent_dir)/chrome_zlib.lib',
          '<(libchromiumcontent_dir)/cld2_static.lib',
          '<(libchromiumcontent_dir)/common.lib',
          '<(libchromiumcontent_dir)/common_constants.lib',
          '<(libchromiumcontent_dir)/common_net.lib',
          ...
          '<(libchromiumcontent_dir)/web_cache_common.lib',
