...
#ifndef ELECTRON_BROWSER_ATOM_SPEECH_RECOGNITION_MANAGER_DELEGATE_H_
#define ELECTRON_BROWSER_ATOM_SPEECH_RECOGNITION_MANAGER_DELEGATE_H_
...
#endif  // ELECTRON_BROWSER_ATOM_SPEECH_RECOGNITION_MANAGER_DELEGATE_H_
