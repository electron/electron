...
const attachGuest = function (embedder, elementInstanceId, guestInstanceId, params) {
  ...
  webPreferences = {
    ...
    images: !params.disableimages,
    javascript: !params.disablejavascript,
    webgl: !params.disablewebgl,
    webaudio: !params.disablewebaudio,
    allowDisplayingInsecureContent: params.displayinsecurecontent,
    allowRunningInsecureContent: params.runinsecurecontent,
