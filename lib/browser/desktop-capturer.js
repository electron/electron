...
exports.getSources = (event, captureWindow, captureScreen, captureTab, thumbnailSize, fetchWindowIcons) => {
  const options = {
    captureWindow,
    captureScreen,
    captureTab,
  ...
  const getSources = new Promise((resolve, reject) => {
    ...
    request.capturer.startHandling(captureWindow, captureScreen, captureTab, thumbnailSize, fetchWindowIcons)
