...
const capturerResult = (id) => `${ipcMessages.desktopCapturer.getSourcesResult}_${id}`

ipcMainInternal.on(ipcMessages.desktopCapturer.getSources, (event, captureWindow, captureScreen, thumbnailSize, fetchWindowIcons, id) => {
