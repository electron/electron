...
ipcMainInternal.on(ipcMessages.navigationController.goBack, function (event) {
  event.sender.goBack()
})

ipcMainInternal.on(ipcMessages.navigationController.goForward, function (event) {
  event.sender.goForward()
})

ipcMainInternal.on(ipcMessages.navigationController.goToOffset, function (event, offset) {
  event.sender.goToOffset(offset)
})

ipcMainInternal.on(ipcMessages.navigationController.length, function (event) {
