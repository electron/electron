...
Menu.prototype.popup = function (options = {}) {
  ...
  let { window, x, y, positioningItem, initiatedByKeyboard, callback } = options;
  ...
  if (typeof initiatedByKeyboard !== 'boolean') initiatedByKeyboard = false;
  ...
  this.popupAt(window as unknown as BaseWindow, x, y, positioningItem, initiatedByKeyboard, callback);
