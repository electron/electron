import { PDFPageSizes, isValidCustomPageSize, sanitizePrintOptions } from '@electron/internal/browser/api/printing-utils';
...
WebContents.prototype.printToPDF = async function (options) {
  const printSettings = sanitizePrintOptions(options, getNextId);
