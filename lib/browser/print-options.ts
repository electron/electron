...
export function normalizePrintOptions(options: unknown): ElectronInternal.NormalizedPrintOptions | null {
  ...
  return {
    ...
    mediaSize: parsePageSize(o.pageSize) ?? (o.usePrinterDefaultPageSize ? null : withImageableArea(pageSizes.A4)),
    usePrinterDefaultPageSize: optional(o.usePrinterDefaultPageSize, 'boolean', false)
  };
}
