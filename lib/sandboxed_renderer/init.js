...
const {
  contentScripts, preloadScripts, webPreferences, isRemoteModuleEnabled, isWebViewTagEnabled, process: processProps
...
if (process.isMainFrame) {
  ...
  webViewInit(webPreferences.contextIsolation, isWebViewTagEnabled, guestInstanceId)
}
