...
exports.getSources = (options) => {
  return new Promise((resolve, reject) => {
    ...
    const captureTab = options.types.includes('tab')
    ...
    ipcRendererUtils.invoke('ELECTRON_BROWSER_DESKTOP_CAPTURER_GET_SOURCES', captureWindow, captureScreen, captureTab, options.thumbnailSize, options.fetchWindowIcons)
