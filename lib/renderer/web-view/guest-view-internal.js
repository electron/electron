...
module.exports = {
  ...
  createGuest: function (params, callback) {
    requestId++
    ipcRendererInternal.send(ipcMessages.guestViewManager.createGuest, params, requestId)
    ipcRendererInternal.once(`ELECTRON_RESPONSE_${requestId}`, callback)
  },
  createGuestSync: function (params) {
    return ipcRendererInternal.sendSync(ipcMessages.guestViewManager.createGuestSync, params)
  },
  destroyGuest: function (guestInstanceId) {
    ipcRendererInternal.send(ipcMessages.guestViewManager.destroyGuest, guestInstanceId)
  },
  attachGuest: function (elementInstanceId, guestInstanceId, params, contentWindow) {
    ...
    ipcRendererInternal.send(ipcMessages.guestViewManager.attachGuest, embedderFrameId, elementInstanceId, guestInstanceId, params)
  }
}
