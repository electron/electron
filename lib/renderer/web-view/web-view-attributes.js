...
class SrcAttribute extends WebViewAttribute {
  ...
  parse() {
    if (!this.webViewImpl.elementAttached
        || !this.webViewImpl.attributes[webViewConstants.ATTRIBUTE_PARTITION].validPartitionId
        || !this.getValue()) {
      return
    }
...
WebViewImpl.prototype.setupWebViewAttributes = function() {
  this.attributes = {
    [webViewConstants.ATTRIBUTE_PARTITION]: new PartitionAttribute(this),
    [webViewConstants.ATTRIBUTE_SRC]: new SrcAttribute(this),
    [webViewConstants.ATTRIBUTE_HTTPREFERRER]: new HttpReferrerAttribute(this),
    [webViewConstants.ATTRIBUTE_USERAGENT]: new UserAgentAttribute(this),
    [webViewConstants.ATTRIBUTE_NODEINTEGRATION]: new BooleanAttribute(webViewConstants.ATTRIBUTE_NODEINTEGRATION, this),
    [webViewConstants.ATTRIBUTE_PLUGINS]: new BooleanAttribute(webViewConstants.ATTRIBUTE_PLUGINS, this),
    [webViewConstants.ATTRIBUTE_DISABLEWEBSECURITY]: new BooleanAttribute(webViewConstants.ATTRIBUTE_DISABLEWEBSECURITY, this),
    [webViewConstants.ATTRIBUTE_ALLOWPOPUPS]: new BooleanAttribute(webViewConstants.ATTRIBUTE_ALLOWPOPUPS, this),
    [webViewConstants.ATTRIBUTE_ENABLEREMOTEMODULE]: new EnableRemoteModuleAttribute(this),
    [webViewConstants.ATTRIBUTE_PRELOAD]: new PreloadAttribute(this),
    [webViewConstants.ATTRIBUTE_BLINKFEATURES]: new BlinkFeaturesAttribute(this),
    [webViewConstants.ATTRIBUTE_DISABLEBLINKFEATURES]: new DisableBlinkFeaturesAttribute(this),
    [webViewConstants.ATTRIBUTE_WEBPREFERENCES]: new WebPreferencesAttribute(this),
  }
}
