...
const registerWebViewElement = function () {
  webFrame.registerEmbedderCustomElement(() => {
    const WebViewElement = class extends HTMLObjectElement {
    ...
    WebViewElement.attributeChangedCallback = function (name, oldValue, newValue) {
    ...
    WebViewElement.disconnectedCallback = function () {
      const internal = v8Util.getHiddenValue(this, 'internal')
      if (!internal) {
        return
      }
    ...
    WebViewElement.connectedCallback = function () {
      const internal = v8Util.getHiddenValue(this, 'internal')
      if (!internal) {
        return
      }
    ...
    // behavior.
    delete WebViewElement.connectedCallback
    delete WebViewElement.disconnectedCallback
    delete WebViewElement.attributeChangedCallback
  })
}
