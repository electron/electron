...
import { defer, ifdescribe, isTestingBindingAvailable, startRemoteControlApp, waitUntil } from './lib/spec-helpers';
...
ifdescribe(isTestingBindingAvailable())('fuses', () => {
  ...
  describe('device_bound_sessions', () => {
    ...
    const certificates = path.join(__dirname, 'fixtures', 'certificates');
