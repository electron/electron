...
import { net, ClientRequest, ClientRequestConstructorOptions } from 'electron/main';
import * as http from 'node:http';
import * as url from 'node:url';
import { once } from 'node:events';
import { setTimeout } from 'node:timers/promises';
import { collectStreamBody, collectStreamBodyBuffer, getResponse, respondNTimes, respondOnce } from './lib/net-helpers';
