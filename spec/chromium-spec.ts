...
describe('web security', () => {
  ...
  describe('wasm-eval csp', () => {
    ...
    it('wasm codegen is disallowed by default', async () => {
      ...
      expect(r).to.equal(
        "WebAssembly.instantiate(): Compiling or instantiating WebAssembly module violates the following Content Security policy directive because 'unsafe-eval' is not an allowed source of script in the following Content Security Policy directive:"
      );
    });
