...
describe('autofill', () => {
  ...
  it('can be selected via keyboard', async () => {
    ...
    w.webContents.sendInputEvent({ type: 'rawKeyDown', keyCode: 'Tab' });
    ...
    w.webContents.sendInputEvent({ type: 'rawKeyDown', keyCode: 'Down' });
    w.webContents.sendInputEvent({ type: 'rawKeyDown', keyCode: 'Enter' });
