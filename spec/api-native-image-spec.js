...
describe('nativeImage module', () => {
  ...
  const images = [
    ...
    {
      dataUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAIAAAD91JpzAAAAFklEQVQYlWP8//8/AwMDEwMDAwMDAwAkBgMBBMzldwAAAABJRU5ErkJggg==', // eslint-disable-line max-len
      filename: '2x2.jpg',
  ...
  /**
   * @param {!Object} filters
   * @return {!Array} A matching images list.
   */
  ...
  /**
   * @param {!Object} filters
   * @return {Object} A matching image if any.
   */
