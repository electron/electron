...
export async function createArtifact(fileName: string, data: Buffer): Promise<void> {
  if (!IS_CI) {
    return;
  }
...
export async function createArtifactWithRandomId(makeFileName: (id: string) => string, data: Buffer): Promise<string> {
