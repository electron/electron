...
describe('security warnings', () => {
  ...
  it('should warn about Node.js integration with remote content', async () => {
    ...
    const [,, message] = await findEmit(w.webContents, 'console-message', messageContainsSecurityWarning);
  ...
  it('should not warn about Node.js integration with remote content from localhost', async () => {
    ...
    const [,, message] = await findEmit(w.webContents, 'console-message', isLoaded);
