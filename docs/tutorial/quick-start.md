...
3. Line 16: You create a new browser window by invoking the `createWindow` function once the Electron application [is initialized](https://www.electronjs.org/docs/api/app#appwhenready).
