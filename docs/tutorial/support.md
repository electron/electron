...
Electron 11.0.0 and later include native support for Apple Silicon (`arm64`) devices.
...
[Electron 6.0.8 and later include native support for Windows on Arm (`arm64`) devices](windows-arm.md).
