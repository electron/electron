...
The app icon in the dock or taskbar can be used to display a progress bar. This allows gives the user some information without having to switch to the window itself. Each platform displays this in their own way.
