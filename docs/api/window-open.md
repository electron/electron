...
has to be a field of `BrowserWindow`'s options. These are the features you can set via `features` string: `zoomFactor`, `preload`, `javascript`, `contextIsolation`, `webviewTag`.
