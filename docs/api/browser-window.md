...
* `options` Object (optional)
  ...
  * `skipTaskbar` boolean (optional) _macOS_ _Windows_ - Whether to show the window in taskbar.
    Default is `false`.
  * `ignoreMissionControl` boolean (optional) _macOS_ - Whether MacOS should ignore the window when the user toggles into mission control.
...
#### `win.setIgnoreMissionControl(ignore)` _macOS_

* `ignore` boolean

Sets whether MacOS should ignore the window when the user toggles into mission control.

#### `win.isIgnoredByMissionControl()` _macOS_

Returns `boolean` - Whether MacOS is ignoring the window when the user toggles into mission control.
