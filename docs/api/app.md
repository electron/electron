...
* `options` Object
  ...
  * `iconPath` String (optional) _Linux_ _Windows_ - Path to the app's icon with `.jpg` or `.png` extensions (`.ico` doesn't supported). On Linux, will be shown as 64x64 pixels while retaining aspect ratio.
