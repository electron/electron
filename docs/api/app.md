...
* `name` string - You can request the following paths by the name:
  ...
  * `userData` The directory for storing your app's configuration files, which
    ...
    may backup this directory to cloud storage. To avoid conflicts with files
    Chromium may write in this directory, store your app's own files in an
    app-specific subdirectory under `userData`.
