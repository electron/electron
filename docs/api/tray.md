...
* If you are bundling your application (e.g., with webpack for development), MacOS will not magically invert your image's colors or use the high density image. This only happens when the application is bundled and run from its DMG.
