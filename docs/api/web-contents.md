...
* `rect` [Rectangle](structures/rectangle.md) (optional) - The area of the page to be captured.  Default is the whole page.
* `opts` Object (optional)
...
The size of the returned [NativeImage](native-image.md) will be `outputSize`.
