...
* `options` Object
  ...
  * `generateTaggedPDF` boolean (optional) - Whether or not to generate a tagged (accessible) PDF. Defaults to false. This property is **experimental** and the generated PDF may not adhere fully to PDF/UA and WCAG standards.
