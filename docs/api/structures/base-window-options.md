...
* `name` string (optional) – A unique identifier for the window, used to enable features such as state persistence. Each window must have a distinct name; a name can only be reused after the corresponding window has been destroyed.
