...
* `introductoryPrice` [ProductDiscount](product-discount.md) - The object containing introductory price information for the product.
...
* `subscriptionPeriod` [ProductSubscriptionPeriod](product-subscription-period.md) - The period details for products that are subscriptions.
