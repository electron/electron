...
If you are adding or modifying an API to Electron, see the [Electron API Design Guidelines](./api-best-practices.md) for
an in-depth review of API design best-practices.
