...
class ProcessSingleton {
 public:
  ...
  using NotificationCallback = base::RepeatingCallback<bool(
      ...
      const base::Value* additional_data)>;
 ...
 protected:
  ...
  NotifyResult NotifyOtherProcessWithTimeout(
      ...
      const std::string& int retry_attempts,
 ...
 private:
  ...
  base::Value* additional_data_ =
      nullptr;  // Custom data to pass to the other instance during notify.
