...
When an issue is posted in a language other than English, it is acceptable and encouraged to post an English-translated copy as a reply.
...
**Please note** that using non-English as an attempt to circumvent our [Code of Conduct](https://github.com/electron/electron/blob/main/CODE_OF_CONDUCT.md) will result in an immediate, and possibly indefinite, ban from the project.
