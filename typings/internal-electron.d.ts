...
declare namespace Electron {
  ...
  interface WebContents {
    ...
    _callWindowOpenHandler(event: Electron.Event, url: string, frameName: string,
    ...
    ): {browserWindowConstructorOptions: Electron.BrowserWindowConstructorOptions | null, outlivesOpener: boolean};
